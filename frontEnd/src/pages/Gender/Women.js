...
class Women extends React.Component {
    ...
    getListProduct = async (pageNumber) => {
        ...
        var payload = { page: pageNumber, limit: 12, category: 'women' }
    ...
    render() {
        ...
        return (
            <div>
                ...
                <DisplayListProduct products={this.state.listProduct} {...this.props} getListProduct={e => this.getListProduct(e)} total={this.state.total} options={womanOption} gender="women" />
            </div>)
